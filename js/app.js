...
var Homepage = Barba.BaseView.extend({
  ...
  if ( document.documentElement.lang.toLowerCase() === "fr" || document.documentElement.lang.toLowerCase() === "en") {
    ...
    //  'https://maps.googleapis.com/maps/api/js?key=AIzaSyCFPZtyZJoAJtnYcwXmVePsWHh-O2lyBwE&region=FR&language=fr&callback=myMap';
  } else if ( document.documentElement.lang.toLowerCase() === "kr" ) {
     script2.src = mapKoKey;
    //  'https://maps.googleapis.com/maps/api/js?key=AIzaSyCFPZtyZJoAJtnYcwXmVePsWHh-O2lyBwE&region=KO&language=ko&callback=myMap';
  }
